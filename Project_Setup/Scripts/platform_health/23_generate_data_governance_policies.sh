...
echo "[23] Generating data governance policies"

BASE_DIR=$(git rev-parse --show-toplevel)
DG_DIR="$BASE_DIR/docs/data_governance/platform_health"

mkdir -p "$DG_DIR"

cat <<EOF > "$DG_DIR/data_governance.md"
...
echo "[23] Data governance policies generated"
